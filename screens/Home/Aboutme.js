    ...
    >
      ...
      <Box width={isMobile ? "" : "55%"}>
        ...
        >
          ...
          impact. */}
          I&apos;m a dedicated Software Engineer with a proven track
          record. My journey began with an internship at MyCrib, where I
          showcased my skills and dedication, leading to a part-time front-end
          developer position. Alongside my pursuit of a Degree in Computer
          Science (Software Engineering), I specialize in web app
          development, leveraging tools like React and Next. I prioritize
          staying ahead of tech trends to deliver innovative solutions in the
          ever-changing software engineering landscape.
        </Text>
      </Box>
    </Stack>
  );
