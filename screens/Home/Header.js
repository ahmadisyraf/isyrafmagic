        ...
        <Box bg="#DCD6F7" borderRadius={15}>
            <Box px={isMobile ? 10 : 200} py={20}>
                ...
                <Text fontSize="xl" textAlign="center" mt={5}>
                    I&apos;m a software engineer based in <b>Malaysia</b>. My primary focus is web app development, and I have a strong passion for exploring and learning new technologies. When it comes to building applications, my go-to tools are <b>React and Next</b>. I strive to stay updated with the latest tech trends, enabling me to tackle new challenges and deliver innovative solutions in the ever-evolving field of software engineering.
                </Text>
